...
app.get('/regexp', (req, res) => {
  res.render('regexp', { title: '정규표현식' });
});

// regexp getForm
app.get('/regexpGetForm', (req, res) => {
  res.render('regexp_result', {
    title: '정규표현식 get 결과',
    userInfo: res.query,
  });
});
...
// regexp postForm
app.post('/regexpPostForm', (req, res) => {
  res.render('regexp_result', {
    title: '정규표현식 post 결과',
    userInfo: res.body,
  });
...
app.get('/postInfo', (req, res) => {
  res.render('training2_post', { title: '[실습 2] post로 정보 받기' });
});

app.post('/postInfoForm', (req, res) => {
  // console.log(req.body);
  res.render('postInfo', {
    title: '[실습 2] post로 받은 정보 결과',
    userInfo: req.body,
  });
});
