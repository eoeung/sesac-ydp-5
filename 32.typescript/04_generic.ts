...
console.log(strArrLen(['a', 'b', 'c', 'd'])); // 4
...
console.log(arrLen<string>(['a', 'b', 'c', 'd'])); // 4
console.log(arrLen<string | number>(['a', 1])); // 2
...
printSome<boolean[]>([true, false], [false, false]); // [true, false] [false, true]
...
// {
//     company: 'apple',
//     createdAt: 2023-10-20T06:45:24.167Z,
